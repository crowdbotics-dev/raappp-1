"""
Django settings for raappp_1 project.
...
WSGI_APPLICATION = 'raappp_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raappp_1 API",
    "DESCRIPTION": "API documentation for raappp_1 App",
    "VERSION": "v1",
}
